  ...
  const steps = [
    {
      ...
      content: "Arcadia is an on-chain arcade where you stake USDm and play skill-based games. Your payout depends on your performance!",
    },
    {
      title: "How It Works 💰",
    ...
    {
      title: "Ready to Play? 🚀",
      content: "Connect your wallet, choose a game, stake some USDm, and test your skills. Good luck!",
    },
  ];
